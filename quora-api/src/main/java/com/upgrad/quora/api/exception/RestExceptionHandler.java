...
public class RestExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> signUPFailedException(SignUpRestrictedException exc, WebRequest request) {
    ...
    public ResponseEntity<ErrorResponse> signOutExceptionException(SignOutRestrictedException exc, WebRequest request) {
        return new ResponseEntity<ErrorResponse>(
                new ErrorResponse().code(exc.getCode()).message(exc.getErrorMessage()), HttpStatus.UNAUTHORIZED
        );
    }
    ...
    public ResponseEntity<ErrorResponse> userNotFoundExceptionException(UserNotFoundException exc, WebRequest request) {
        return new ResponseEntity<ErrorResponse>(
